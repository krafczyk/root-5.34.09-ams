...
excl="main proof/proofd proof/clarens proof/peac net/rootd net/xrootd rootx \
      montecarlo/pythia6 montecarlo/pythia8 sql/mysql sql/pgsql  \
      ...
      net/krb5auth net/globusauth io/chirp io/dcache net/alien \
       net/ldap graf2d/qt gui/qtroot math/quadp \
      bindings/pyroot bindings/ruby  \
      io/xmlparser graf3d/gl graf3d/ftgl roofit/roofit roofit/roofitcore \
      roofit/roostats roofit/histfactory sql/oracle  net/auth \
      net/rpdutils math/mathmore  io/gfal net/monalisa \
      proof/proofx math/fftw gui/qtgsi sql/odbc  math/unuran \
