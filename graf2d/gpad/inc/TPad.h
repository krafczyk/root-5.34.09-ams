...
///   void              DrawTextNDC(Double_t u, Double_t v, const char *text);
   ...
   void              PaintFillArea3D(Int_t n, Float_t *p1, Option_t * opt="");

   void              PaintFillAreaHatches(Int_t n, Double_t *x, Double_t *y, Int_t FillStyle);
   void              PaintHatches(Double_t dy, Double_t angle, Int_t nn, Double_t *xx, Double_t *yy);
   void              PaintPadFrame(Double_t xmin, Double_t ymin, Double_t xmax, Double_t ymax);
   void              PaintLine(Double_t x1, Double_t y1, Double_t x2, Double_t y2);
   void              PaintLine(Double_t x1, Double_t y1, Double_t x2, Double_t y2, Color_t color);
...
//   void              PaintPolyLine(Int_t n, Float_t *x, Float_t *y, Color_t color,Option_t *option="");
//   void              PaintPolyLine(Int_t n, Double_t *x, Double_t *y, Color_t color,Option_t *option="");
